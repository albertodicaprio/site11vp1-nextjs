...
const privatePageBackground =
  'https://media.myswitzerland.com/image/fetch/w_2560,h_1120,c_limit,f_auto,q_auto,e_sharpen:50/https%3A%2F%2Fwww.myswitzerland.com%2F-%2Fmedia%2Fcelum%20connect%2F2025%2F08%2F14%2F06%2F19%2F10%2Fnyon-chateau.jpg';
  ...
  if (!isLoggedIn) {
    return (
      <div
        ...
        style={{
          backgroundImage: `url(${privatePageBackground})`,
        }}
      >
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold">Bienvenue à l'espace privé de la 11VP1</h1>
