...
export default function Home() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="mb-12">
        <h1 className="text-4xl font-bold mb-2">Bienvenue à la classe 11VP1</h1>
        <p className="text-gray-600 text-lg">Site officiel pour notre classe à l'école au Marens, Suisse</p>
      </div>
      ...
      {/* Holidays Section */}
      <div className="mb-12">
        <h2 className="text-3xl font-bold mb-6">Vacances scolaires</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-2xl font-semibold mb-4 text-black">sur ce site</h3>
